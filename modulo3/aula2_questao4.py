...
## Processamento
g = (classe == "guerreiro" and força >= 15) and (classe == "guerreiro" and magia <=10)
## Processamento
if classe == "guerreiro":
## Saída e impressão
    print("Pontos de atributo consistentes com a classe escolhida:", g)


## Processamento
m = (classe == "mago" and força <=10) and (classe == "mago" and magia >=15)
## Processamento
if classe == "mago":
## Saída e impressão
    print("Pontos de atributo consistentes com a classe escolhida:", m)
    
## Processamento
a = (classe == "arqueiro" and força >= 5 and força <=15) and (classe == "arqueiro" and magia >=5 and magia <=15)
## Processamento
if classe == "arqueiro":
## Saída e impressão
    print("Pontos de atributo consistentes com a classe escolhida:", a)
